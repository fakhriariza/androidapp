...
class AdapterBerita2 extends RecyclerView.Adapter<AdapterBerita2.MyViewHolder> {
    // Buat Global variable untuk manampung context
    Context context;
    List<BeritaItem> berita;
    public AdapterBerita2(Context context, List<BeritaItem> data_berita) {
        // Inisialisasi
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        // Dapatkan url gambar
        final String urlGambarBerita = "http://lpik.masuk.web.id/admin/gambar/" + berita.get(position).getFoto();
